...
if __name__ == "__main__":
    ...
    dataset = sys.argv[1]
    measure_power_secs = int(sys.argv[2])
    modelPATH = sys.argv[3]
    nbrEpoch = int(sys.argv[4])
    learningRate = float(sys.argv[5])
    optimizer = sys.argv[6]
    loss = sys.argv[7]
    emission_output_directory = sys.argv[8]
    emission_output_file = sys.argv[9]
    final_result_PATH = sys.argv[10]
    batch_sizes = int(sys.argv[11])

    print(sys.argv)

    results, code_carbon_output_path = Experiment(dataset=dataset,
                                                  measurePowerSecs=measure_power_secs,
                                                  ...
                                                  optimizer=optimizer,
                                                  loss=loss,
                                                  emission_output_directory=emission_output_directory,
                                                  emission_output_file=emission_output_file
                                                  )
